...
//===============================================================================================================	
		...
		public String listcategory(@ModelAttribute("cri") SearchCriteria cri, Model model, HttpServletRequest request) throws Exception {
...
//================================================================================================================		
	    ...
	    @ResponseBody																  	
	    public String commentInsert(@ModelAttribute("commentVO") CommentVO commentvo, HttpServletRequest request) throws Exception{
 ...
 //================================================================================================================		
	...
	//댓글 수정창
	   ...
	   public String commentUpdateForm(Model model, int reply_num, String reply_content)throws Exception {//@RequestParam("reply_num") int reply_num, Model model
 ...
 //=========================매니저보드테스트==================================================================================
	...
	//==================매니져보드카테고리================================================================================================	
		...
		public String managerBoard_category(@ModelAttribute("cri") SearchCriteria cri, Model model, HttpServletRequest request) throws Exception {
		    String board_category= request.getParameter("board_category");
		    cri.setBoard_category(board_category);
