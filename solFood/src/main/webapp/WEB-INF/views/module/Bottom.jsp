...
<div class="row" style="position: relative; font-size: 12px; font-weight: normal; color: #8C8C8C;">
	<div class="col-xs-1 col-xs-offset-1"><input type="button" class="btn btn-default" value="카카오톡 문의" onClick="window.open('http://pf.kakao.com/_xgWFsT')"><br><br><br><input type="button" class="btn btn-default" value="1:1 문의"></div>
...
<hr>
<div class="row">
	<div class="col-md-5 col-md-offset-1"><a href="${path}/intro.do">SolFood소개</a>｜<a href="${path}/accessTerms.do">이용약관</a>｜<a href="${path}/personalInfo.do">개인정보처리방침</a>｜<a href="${path}/guide.do">이용안내</a></div>
