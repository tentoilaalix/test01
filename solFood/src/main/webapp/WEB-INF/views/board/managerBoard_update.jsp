...
<body>
	<div class="container">
	  		 <h1 align="center">${view.board_title}의 게시글 수정</h1><br>
		<form class= "form-horizontal" method="post">
			<input type="hidden" name="board_num" value="${view.board_num}" />
			<div class="form-group">
				<label class="control-label col-sm-2">제목</label>
				<div class="col-sm-3"> 
					<input type="text" class ="form-control" name="board_title" value="${view.board_title}"  />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="control-label col-sm-2">작성날짜</label> 
					<div class="col-sm-3"> 
						<input type="text" class ="form-control"name ="board_date" value="<fmt:formatDate value="${view.board_date}" pattern="yyyy-MM-dd" />" readonly="readonly"/>
					</div>
			</div>
			<div class="form-group">
