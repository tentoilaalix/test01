...
<body>
		<div class="container">
	 	  <h1 align ="center">MANAGER 게시판 등록</h1><br>
	      ...
	      <div class="form-group">
	        ...
	        <div class="col-sm-3">
	           <input type="text" class="form-control" name="board_title" maxlength="50" placeholder="Enter Title">
	        </div>
	      </div>
	      ...
	      <div class="form-group">
	        ...
	        <div class="col-sm-3">
	           <input type="text" class="form-control" name="account_user" maxlength="50" placeholder="Enter Writer">
	        </div>
	      </div>
