	...
	<div class="row"> <!-- left category -->
		...
		<br><br><br>
			...
			<ul class= "nav nav-sidebar" align="center">
			 	<li class="active" ><a href="/board/listPage">BOARD CATEGORY<span class="sr-only">(current)</span></a></li>
				<li><a href="/board/selectByCategory?board_category=notice"><span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;&nbsp;공지사항</a></li>
				<li><a href="/board/selectByCategory?board_category=event"><span class="glyphicon glyphicon-gift"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;이벤트</a></li>
				<li><a href="/board/selectByCategory?board_category=proposal"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;상품제안</a></li>
				<li><a href="/board/selectByCategory?board_category=question"><span class="glyphicon glyphicon-question-sign"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Q&A</a></li>
			</ul>
		</div>
<!-- ===================검색기능========================================================================================== -->				
		<div class="col-md-10">
...
<!-- ============================================================================================================= -->						
				...
				<tbody>
					...
					<%-- 영민 --%> <%-- 위에 list를 ${fn:length(list)}로 대신해서 사용해서 리스트수를 알아낸다 --%>
