...
<title>SolFood소개</title>
	...
	function intro_eng(){			
		...
		$.ajax({
			success: function(){
				...
				c+="<p>''<br>비싼 식자재만이 좋은 음식일 것이라고 막연하게 생각하고 있는<br>소비자에게는 진짜 맛을 소개해드리고 싶었고,<br>뚝심 하나로 산골 오지에서 수십 년간 묵묵히 장을 담그는 명인, <br>시들어서 버릴지언정 무농약을 고집하는 농부에게는 안정적인 판매 활로를 찾아드리고 싶었습니다.<br>생산자와 소비자, 판매자까지 모두 행복하고 맛있는 삶을 살 수 있도록<br>'Solfood'는 오늘도 열심히 발로 뛰며 고민합니다.<br>''</p>";				$("#company3").html(c);
				$("#company3").html(c);
	...
	<style type="text/css">
		...
		.intro-text{ color: gray!important; text-decoration: none !important; font-size:"12px"; font-family: 'Noto Sans KR', sans-serif !important;}
...
<body>
	...
	<br>
	<br>
	<div id="company2" class="intro-text" align="center" Style="font-size:19px;">
	<p>
	"<br>
	맛있는 음식이 삶의 가장 큰 즐거움이라 믿는 사람들이 뜻을 합쳤죠.<br>
	'Solfood'의 팀원들은 이미 팀을 꾸리기 전부터 좋은 재료를 위해서라면 해외 직구, 백화점, 동네 마트, 재래 시장,<br>
	...
	<div id="company3" class="intro-text" align="center" Style="font-size:19px;">
	<p>
	"<br>
	...
	생산자와 소비자, 판매자까지 모두 행복하고 맛있는 삶을 살 수 있도록<br>
	 'Solfood'는 오늘도 열심히 발로 뛰며 고민합니다.<br>
	 "</p>
	</div>
	<br>
	<br>
