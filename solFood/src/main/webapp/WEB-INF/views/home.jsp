    ...
    <div class="row">
		<div class="col-md-12">
                ...
                <div class="item active">
                	<div class="row">
                	  <div class="col-md-3"><a href="${path}/product/productInfo.do?product_id=1" class="thumbnail"><img src="../resources/image/goods1.jpg" style="max-width:100%;"></a><br>
                	  <a href="${path}/product/productInfo.do?product_id=1" class="noul"><strong>[신선한특가]식빵+유기농 제주 목초 우유</strong><br>
						<%=nf.format(5900)%>원</a></div>
                	 <div class="col-md-3"><a href="${path}/test.do" class="thumbnail"><img src="../resources/image/goods2.jpg" style="max-width:100%;"></a><br>
                	   <a href="${path}/test.do" class="noul"><strong>[신선한특가] DOLE 실속 바나나</strong><br>
